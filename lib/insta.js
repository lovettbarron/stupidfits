...
const MEDIA_FIELDS =
  "username,id,permalink,caption,media_type,media_url,thumbnail_url,timestamp,like_count";
const CHILDREN_FIELDS =
  "username,id,permalink,media_type,media_url,thumbnail_url,timestamp,like_count";
  ...
  async fetchMedia(after = "", limit = null) {
    ...
    const data = {
      fields: this.settings.fetchChildren
        ? MEDIA_FIELDS + `,children{${CHILDREN_FIELDS}}`
        : MEDIA_FIELDS,
      access_token: this.token,
