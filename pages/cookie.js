...
const Cookie = (props) => {
  return (
    <Layout>
      ...
      <h2>The basics</h2>
      <p>
        This site doesn't work without cookies. Would that it were so, but alas.
      </p>

      <h2>Cookie Policy</h2>
      <p>
        We use cookies to help improve your experience of{" "}
        <a href="https://stupidfits.com">https://stupidfits.com</a>. This cookie
        policy is part of Stupid Systems LLC's privacy policy, and covers the
        use of cookies between your device and our site. We also provide basic
        information on third-party services we may use, who may also use cookies
      ...
      <p>
        ...
        <a href="https://stupidfits.com">https://stupidfits.com</a>, with the
      ...
      <p>
        ...
        no control over third-party cookies, they are not covered by Stupid
        Systems LLC's cookie policy.
      </p>
