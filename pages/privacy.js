  ...
  return (
    <Layout>
      ...
      <p>
        ...
        let me know and I can help you out! alb@andrew.com
      </p>
      <ol>
        <li>You can delete your account at any time</li>
        <li>You can download all of your data any time</li>
        <li>
          Some of your data might go to third parties, like Instagram. We'll try
          to make that as obvious and clear as possible.
        </li>
      </ol>
      <h2>The Details</h2>
      ...
      <p>
        Your privacy is important to us. It is Stupid Systems LLC's policy to
        respect your privacy regarding any information we may collect from you
        across our website,{" "}
        <a href="https://stupidfits.com">https://stupidfits.com</a>, and other
      ...
      <p>
        <strong>Stupid Systems LLC Data Controller</strong>
        <br />
        Andrew Lovett-Barron
        <br />
        alb@andrewlb.com
      </p>
      <p>This policy is effective as of September 1, 2020.</p>
    </Layout>
  );
};
